import sys
from LN_Programming_Solve69 import Problem, Dict, Phase1, Phase2, S2P_Method
import numpy as np
import streamlit as st

# Thiết lập tiêu đề trang và logo
st.set_page_config(page_title="Chương Trình Giải Bài Toán Quy Hoạch Tuyến Tính", page_icon=":bar_chart:")
